...
import { reverseSokobanMedia, reverseSokobanMediaSwiper } from "./assets/images";


function ReverseSokoban() {
      ...
      >
        <div className="container-project">
          ...
          <div className="container-project-slider"> 
              <ProjectSwiper projectMedia={reverseSokobanMediaSwiper} embededVideo={false} videoLink=""/> 
          </div>
        ...
        <div className="project-details">
          ...
          <h1> Development </h1>
            ...
            <img src={reverseSokobanMedia[1]} style={{height: '50%'}}/>
